        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center space-y-6 mb-12 animate-fade-in-up">
            <h2 className="text-4xl lg:text-5xl font-bold">
              Get Started with
              <span className="bg-gradient-primary bg-clip-text text-transparent"> AI Booking</span>
            </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      placeholder="Let’s talk about your biz! How are you booking clients right now, and where could things be smoother?"
                      rows={4}
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Get your AI booking system running.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">From 10 to 10,000 bookings per month, we grow with you</p>
                    </div>
                  </div>
                </div>
              </div>
